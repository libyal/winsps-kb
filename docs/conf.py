...
# Change PYTHONPATH to include winspsrc module and dependencies.
...
project = 'Windows Serialized Property Store (SPS) knowledge base'
copyright = 'The Windows Serialized Property Store (SPS) knowledge base authors'
version = winspsrc.__version__
release = winspsrc.__version__
...
def RunSphinxAPIDoc(app):
  ...
  module_path = os.path.join(current_directory, '..', 'winspsrc')
