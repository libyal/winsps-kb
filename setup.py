...
# Change PYTHONPATH to include winspsrc so that we can get the version.
sys.path.insert(0, '.')

import winspsrc  # pylint: disable=wrong-import-position
      ...
      for line in iter(spec_file):
        if line.startswith('Summary: '):
          ...
          lines.extend([
              ...
              '%exclude %{python3_sitelib}/winspsrc/__pycache__/*'])
          ...
          python_spec_file.extend([
              f'Requires: winsps-kb-data >= %{{version}} {requires:s}',
          ...
          python_spec_file.extend([
              ...
              f'Requires: {python_package:s}-winsps-kb >= %{{version}}',
...
setup(
    name='winspsrc',
    version=winspsrc.__version__,
    description=winspsrc_description,
    long_description=winspsrc_long_description,
