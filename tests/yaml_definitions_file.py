...
class YAMLPropertiesDefinitionsFileTest(test_lib.BaseTestCase):
    ...
    def testReadPropertyDefinition(self):
        ...
        test_definitions_file = yaml_definitions_file.YAMLPropertiesDefinitionsFile()
        ...
        with self.assertRaises(RuntimeError):
            test_definitions_file._ReadPropertyDefinition({"bogus": "test"})
    ...
    def testReadFromFile(self):
        ...
        self.assertEqual(
            definitions[0].format_identifier, "00000000-0000-0000-0000-000000000000"
        )
        self.assertEqual(
            definitions[2].format_identifier, "f29f85e0-4ff9-1068-ab91-08002b27b3d9"
        )
