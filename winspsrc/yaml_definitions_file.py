    ...
    * value_type, defines one or more value types used by the property.
    ...
    def _ReadPropertyDefinition(self, yaml_property_definition):
        ...
        if not format_identifier:
            raise RuntimeError("Invalid property definition missing format identifier.")

        property_identifier = yaml_property_definition.get("property_identifier", None)
        ...
        shell_property_key = yaml_property_definition.get("shell_property_key", None)
